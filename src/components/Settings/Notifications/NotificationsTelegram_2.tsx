...
const messages = defineMessages('components.Settings.Notifications', {
  ...
  telegram2settingssaved: 'Telegram (2) notification settings saved successfully!',
  telegram2settingsfailed: 'Telegram (2) notification settings failed to save.',
  toastTelegram2TestSending: 'Sending Telegram (2) test notification…',
  toastTelegram2TestSuccess: 'Telegram (2) test notification sent!',
  toastTelegram2TestFailed: 'Telegram (2) test notification failed to send.',
    ...
    <Formik
      ...
      onSubmit={async (values) => {
        try {
          ...
          addToast(intl.formatMessage(messages.telegram2settingssaved), {
            appearance: 'success',
            autoDismiss: true,
          });
        } catch {
          addToast(intl.formatMessage(messages.telegram2settingsfailed), {
            appearance: 'error',
            autoDismiss: true,
          });
        } finally {
    ...
    >
      {({
        ...
        const testSettings = async () => {
          ...
          try {
            addToast(
              intl.formatMessage(messages.toastTelegram2TestSending),
              {
                autoDismiss: false,
                appearance: 'info',
              },
            ...
            addToast(intl.formatMessage(messages.toastTelegram2TestSuccess), {
              autoDismiss: true,
              appearance: 'success',
            });
          } catch {
            ...
            addToast(intl.formatMessage(messages.toastTelegram2TestFailed), {
              autoDismiss: true,
              appearance: 'error',
            });
          } finally {
